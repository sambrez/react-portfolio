        ...
        <div id="writing" className="row">
          ...
          <div id="paragraphs" className="col container">
            ...
            <p id="pOne" className="center row">
              ...
              Bachelor's of Science in Sustainable Agriculture & Food Systems
              from the University of New Hampshire and have spent the last six
              years working as a winemaker.
            </p>
            <p id="pTwo" className="center row">
              ...
              involved web design, eCommerce, and data management which sparked
              an insatiable interest in the world of web development.
            </p>
            <p id="pThree" className="center row">
              I have spent the last six months intensely studying the basics of
              web design and development and greatly look forward to continuing
              my education and exploring a new field of work and study. The wine
